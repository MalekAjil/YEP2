...
public class CourseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  v= inflater.inflate(R.layout.fragment_continuous_education, container, false);


        all_data.add(new News(1, "الخبر الأول " , "الخبر الاول توصيف " , 2 , "20-12-2021" ,"https://via.placeholder.com/728x200.png?text=hi3"));

        all_data.add(new News(2, "الخبر الثاني " , "الخبر الاول توصيف " , 2 , "20-12-1990" ,"https://via.placeholder.com/728x200.png?text=hi3"));
        all_data.add(new News(3, "الخبر الثالث " , "الخبر الاول توصيف " , 2 , "20-12-2000" ,"https://via.placeholder.com/728x200.png"));
        all_data.add(new News(3, "الخبر الثالث " , "الخبر الاول توصيف " , 2 , "20-12-2000" ,"https://via.placeholder.com/728x200.png"));
        all_data.add(new News(3, "الخبر الثالث " , "الخبر الاول توصيف " , 2 , "20-12-2000" ,"https://via.placeholder.com/728x200.png"));
        all_data.add(new News(3, "الخبر الثالث " , "الخبر الاول توصيف " , 2 , "20-12-2000" ,"https://via.placeholder.com/728x200.png"));
        all_data.add(new News(3, "الخبر الثالث " , "الخبر الاول توصيف " , 2 , "20-12-2000" ,"https://via.placeholder.com/728x200.png"));
