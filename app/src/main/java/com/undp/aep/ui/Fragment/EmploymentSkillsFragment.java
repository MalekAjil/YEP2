...
public class EmploymentSkillsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_employment_skills, container, false);
        ...
        employmentSkillsAdapter = new NewsAdapter(getContext(), GuideActivity.all_news);
        lst_data.setLayoutManager(new GridLayoutManager(getContext(), 1));

        lst_data.setAdapter(employmentSkillsAdapter);
