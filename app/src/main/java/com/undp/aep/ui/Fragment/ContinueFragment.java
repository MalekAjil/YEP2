...
public class ContinueFragment extends Fragment {
    ...
    public static NewsAdapter continueAdapter;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_continue, container, false);
        ...
        continueAdapter = new NewsAdapter(getContext(), GuideActivity.all_news);
        lst_data.setLayoutManager(new GridLayoutManager(getContext(), 1));

        lst_data.setAdapter(continueAdapter);
