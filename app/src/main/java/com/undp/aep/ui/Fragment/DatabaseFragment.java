...
public class DatabaseFragment extends Fragment {
    ...
    public static NewsAdapter databaseAdapter;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //all_data.add(new News(1, "الخبر الرابع " , "الخبر الاول توصيف " , 1 , "20-12-2021" ,"https://via.placeholder.com/728x200.png?text=hi3"));

        RecyclerView lst_data = v.findViewById(R.id.lst_data);
        databaseAdapter = new NewsAdapter(getContext(), GuideActivity.all_news);
        lst_data.setLayoutManager(new GridLayoutManager(getContext(), 1));

        lst_data.setAdapter(databaseAdapter);
